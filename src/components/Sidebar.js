...
export default function Sidebar() {
  return (
    <div className="w-60 flex-none h-full overflow-y-auto flex flex-col items-start p-2 border-r border-gray-200">
      ...
      {/* Making a list draggable and droppable with React Beautiful DnD*/}
      <div className="font-bold"> {"Motion"} </div>
      {/* we want our entire unordered list (<ul>) to be our drop zone */}
       {/* // we set a droppableId on our <Droppable> component. This allows the library to keep track of this specific instance between interactions. */}
